...
<head>
  ...
  <style>
  /*body{
    background: url('Images/Display antrian kamar dokter 4 - on.jpg');
...
<script>
  ...
  document.body.style.background = "url('Images/Display antrian kamar dokter 2 - on.jpg')";

  function movepage() {
    setTimeout(
      function() {
        window.location.href="antrian1show2.php?idruang="+idruang;
      }, 15000);
  }
</script>
