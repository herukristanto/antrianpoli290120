...
<head>
  ...
  body{
    background-image: url('Images/Display antrian kamar dokterPoli 3- on.jpg');
      ...
      function updatedata() {
        ...
        if (status!=0) {
          ...
          if (nomoremg=='y' || nomoremg=='x') {
            window.location.href="ubahflage3.php?idruang="+idruang+"&id="+id;
          }
        ...
        if (status=='0') {
          window.location.href="antrian1off3.php";
        } else if (status=='1') {
          window.location.href="antrian13.php?idruang="+idruang;
        } else if (status=='2') {
          window.location.href="antrian1blink3.php?idruang="+idruang;
        }
      }
    </script>
