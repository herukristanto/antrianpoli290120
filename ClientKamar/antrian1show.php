...
<head>
  ...
  body{
    background-image: url('Images/Display antrian kamar dokter - on.jpg');
      ...
      function updatedata() {
        ...
        if (status!=0) {
          ...
          if (nomoremg=='y' || nomoremg=='x') {
            window.location.href="ubahflage.php?idruang="+idruang+"&id="+id;
          }
        ...
        if (status=='0') {
          window.location.href="antrian1off.php";
        } else if (status=='1') {
          window.location.href="antrian1.php?idruang="+idruang;
        } else if (status=='2') {
          window.location.href="antrian1blink.php?idruang="+idruang;
        }
      }
    </script>
