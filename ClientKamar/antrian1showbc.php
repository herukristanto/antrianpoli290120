...
<head>
  ...
  body{
    background-image: url('Images/Display antrian kamar dokter BC - on.jpg');
      ...
      function updatedata() {
        ...
        if (status!=0) {
          ...
          if (nomoremg=='y' || nomoremg=='x') {
            window.location.href="ubahflagebc.php?idruang="+idruang+"&id="+id;
          }
        ...
        if (status=='0') {
          window.location.href="antrian1offbc.php";
        } else if (status=='1') {
          window.location.href="antrian1bc.php?idruang="+idruang;
        } else if (status=='2') {
          window.location.href="antrian1blinkbc.php?idruang="+idruang;
        }
      }
    </script>
