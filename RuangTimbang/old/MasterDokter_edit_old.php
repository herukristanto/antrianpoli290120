...
$cekdokter = "SELECT Name FROM QP7DOCTOR WHERE Doctor_Id = '" .$id. "'";
$sqlcekd = sqlsrv_query($conn, $cekdokter);
$NamaDokter = sqlsrv_fetch_array($sqlcekd);
$Name = $NamaDokter['Name']; 

$cekstatus = "SELECT Status FROM QP7DOCTOR WHERE Doctor_Id = '" .$id. "'";
$sqlceks = sqlsrv_query($conn, $cekstatus);
$Statusd = sqlsrv_fetch_array($sqlceks);
...
<script type="text/javascript">
  ...
  function edit(R){
   window.location.href = "MasterDokter_edit.php?cmd=call&id="+R;
 } 
...
<div align="center" id="2">
  ...
  <p>&nbsp;</p>
  <form name="form" method="post" action="edit_dokter.php"/> 
  <table width="517" height="225" cellpadding="5" bordercolor="#3300FF">
        <thead>
          <tr>
            <td>ID </td>
            <td>:</td>
            <td height="38"><input name="id" type="text" id="id" size="6" maxlength="5" style="font-size:18px;border-color:#669900" value="<?php echo $id ?>" /></td>
          </tr>
          <tr>
            <td>Nama</td>
            <td>:</td>
            <td height="34"><input name="nama" type="text" id="nama" size="60" maxlength="60" style="font-size:18px;border-color:#669900" value="<?php echo $Name ?>" /></td>
          </tr>
            <tr>
              <td>Status</td>
              <td>:</td>
              <td height="47"><label>
                <input name="pilihstatus" type="radio" value="1" <? if($Status=='1'){?> checked="" <? }?>>
                <span class="style39">Aktif</span></label></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td height="39"><input name="pilihstatus" type="radio" value="2" <? if($Status=='2'){?> checked="" <? }?>>
        ...
        <div id="Layer1">
          <div align="center">
            <table width="921" height="54" border="2" align="center" cellpadding="5" bordercolor="#3300FF">
              <thead>
                <tr>
                  <td width="115" height="46"><div align="center" class="style9 style34">ID  </div>
                      <div align="center" class="style9">
                        <div align="center"></div>
                      </div></td>
                  <td width="443"><div align="center" class="style9 style34">Nama </div></td>
                  <td width="164"><div align="center" class="style9">
                      <div align="center">Status </div>
                  </div></td>
                  <!--<td><div align="center">Kode</div></td>-->
                  <td width="137"><div align="center" class="style9">Action </div></td>
                </tr>
              </thead>
              <tbody>
                <?php
