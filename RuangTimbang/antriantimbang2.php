...
<head>
  ...
  body {
    background-image: url('Images/Display antrian ruang timbang Poli 2- on.jpg');
...
if ($poli=="POLIKLINIK 2") {

  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '14%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '15%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '16%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian3\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '17%' AND kode not like '41%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian4\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '18%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian5\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '19%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian6\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '20%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian7\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '24%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian8\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '25%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian9\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '26%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian10\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '44%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
    echo "
    <table id=\"tabelAntrian11\" border=\"1\" hidden>
    <tr>
    <td>Nomor Antrian</td>
    </tr>";
    while($rs = sqlsrv_fetch_array($sql)) {
...
<body onload='updatedata();'>
  ...
  <script>
    ...
    if (poli=='POLIKLINIK 2') {
      if (status=='2') {
        window.location.href="antriantimbangcall2.php";
      }
    } else {
      ...
      } else if (poli=='BREAST CENTER') {
        window.location.href="antriantimbang6.php";
