...
if ($poli=="POLIKLINIK 3") {

  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '27%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '30%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '33%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '34%' AND kode not like '41%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '35%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '36%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '37%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '38%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '39%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '40%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '42%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
...
<body onload='updatedata();'>
  ...
  <script>
    ...
    if (poli=='POLIKLINIK 3') {
      if (status=='2') {
        window.location.href="antriantimbangcall3.php";
      }
    } else {
