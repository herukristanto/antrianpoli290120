...
if ($poli=="POLIKLINIK 1") {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '3%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '4%' AND kode not like '41%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '5%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '6%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '7%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '8%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
  ...
  $query = "SELECT nomor_antrian FROM V_QP7ANTRIAN WHERE tgl_antrian='".$datenow."' AND status <> 0 AND kode like '41%' AND jam_pasien_timbang_selesai is null AND Nama_Poli LIKE '%".$poli."' order by kode, id";
  $params = array();
  $options =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
  $sql = sqlsrv_query( $conn, $query , $params, $options );
  if ($sql) {
...
<body onload='updatedata();'>
  ...
  <script>
    ...
    if (poli=='POLIKLINIK 1') {
      if (status=='2') {
        window.location.href="antriantimbangcall1.php";
      }
    } else {
